...
export const completionsSchema = {
  ...
  "": [
    {
      label: "test_name",
      type: "keyword",
      info: "Unique name to identify this profile",
      apply: addColonAndQuotes,
    },
    {
      label: "llm",
      type: "keyword",
      info: "LLM Configuration",
      apply: addColonAndIndent,
    },
    {
      label: "user",
      type: "keyword",
    ...
    },
    {
      label: "chatbot",
      type: "keyword",
      info: "Chatbot Configuration",
      apply: addColonAndIndent,
    },
    {
      label: "conversation",
      type: "keyword",
      info: "Conversation Configuration",
      apply: addColonAndIndent,
    },
  ],
  // LLM section
  llm: [
    {
      label: "temperature",
      type: "keyword",
      info: "Controls randomness (0.0 to 1.0)",
      apply: addColonAndSpace,
    },
    {
      label: "model",
      type: "keyword",
      info: "Model to use (e.g., 'gpt-4o-mini')",
      apply: addColonAndSpace,
    },
    {
      label: "format",
      type: "keyword",
      info: "Output format configuration",
      apply: addColonAndIndent,
    },
  ],
  "llm.format": [
    {
      label: "type",
      type: "keyword",
      info: "Format type (text or speech)",
      apply: addColonAndSpace,
    },
    {
      label: "config",
      type: "keyword",
      info: "Path to speech configuration file (if type is speech)",
      apply: addColonAndSpace,
    },
  ],
  "llm.format.type": [
  ...
  user: [
    {
      label: "language",
      type: "keyword",
      info: "The language of the user",
      apply: addColonAndSpace,
    },
    {
      label: "role",
      type: "keyword",
      info: "Define the user's role/behavior",
      apply: addColonAndSpace,
    },
    {
      label: "context",
      type: "keyword",
      info: "List of additional background information",
      apply: addColonIndentAndList,
    },
    {
      label: "goals",
      type: "keyword",
      info: "Define the user's goals and variables",
      apply: addColonIndentAndList,
    },
  ],
  "user.context": [
    {
      label: "personality",
      type: "keyword",
      info: "Path to the personality file",
      apply: addColonAndSpace,
    },
  ],
  "user.goals": [
    {
      label: "function",
      type: "keyword",
      info: "Function types: default(), random(), random(n), random(rand), another(), forward()",
      apply: addColonAndSpace,
    },
    {
      label: "type",
      type: "keyword",
      info: "Variable type (string, int, float)",
      apply: addColonAndSpace,
    },
    {
      label: "data",
      type: "keyword",
      info: "Data can be a list of values or a range",
      apply: addColonAndIndent,
    },
  ],
  "user.goals.function": [
    {
      label: "default",
      type: "function",
      apply: addColonAndBrackets,
      info: "Use all values in the data list",
    },
    {
      label: "random",
      type: "function",
      apply: addColonAndBrackets,
      info: "Pick random value(s). Specify count or use random count",
    },
    {
      label: "another",
      type: "function",
      apply: addColonAndBrackets,
      info: "Pick different values each time until list is exhausted",
    },
    {
      label: "forward",
      type: "function",
      apply: addColonAndBrackets,
      info: "Iterate through values. Can be nested with other variables",
    },
  ],
  "user.goals.type": [
  ...
  "user.goals.data": [
    {
      label: "step",
      type: "keyword",
      info: "Step value for numeric ranges",
      apply: addColonAndSpace,
    },
    {
      label: "min",
      type: "keyword",
      info: "Minimum value for numeric ranges",
      apply: addColonAndSpace,
    },
    {
      label: "max",
      type: "keyword",
      info: "Maximum value for numeric ranges",
      apply: addColonAndSpace,
    },
    {
      label: "any",
      type: "function",
      info: 'Create a variable with the LLM: any("prompt")',
      apply: addColonAndBrackets,
    },
  ],
  // Chatbot section
  chatbot: [
    {
      label: "is_starter",
      type: "keyword",
      info: "Set to True if the chatbot starts the conversation",
      apply: addColonAndSpace,
    },
    {
      label: "fallback",
      type: "keyword",
      info: "Fallback when the input was not understood",
      apply: addColonAndSpace,
    },
    {
      label: "output",
      type: "keyword",
      info: "Variables to extract from the conversation",
      apply: addColonIndentAndList,
    },
  ],
  "chatbot.output": [
    {
      label: "type",
      type: "keyword",
      info: "Types: int, float, money, str, time, date",
      apply: addColonAndSpace,
    },
    {
      label: "description",
      type: "keyword",
      info: "Description of the variable for LLM extraction",
      apply: addColonAndSpace,
    },
  ],
  ...
  conversation: [
    {
      label: "number",
      type: "keyword",
      info: "Can be: number, sample(0.0 to 1.0), or all_combinations",
      apply: addColonAndSpace,
    },
    {
      label: "max_cost",
      type: "keyword",
      info: "Maximum cost in dollars of the total execution",
      apply: addColonAndSpace,
    },
    {
      label: "goal_style",
      type: "keyword",
      info: "Defines how to decide when a conversation is finished",
      apply: addColonAndIndent,
    },
    {
      label: "interaction_style",
      type: "keyword",
      info: "Conversation behavior modifiers",
      apply: addColonIndentAndList,
    },
  ],
  "conversation.goal_style": [
    {
      label: "steps",
      type: "keyword",
      info: "Number of steps before conversation ends",
      apply: addColonAndSpace,
    },
    {
      label: "random_steps",
      type: "keyword",
      info: "Random number of steps between 1 and specified number",
      apply: addColonAndSpace,
    },
    {
      label: "all_answered",
      type: "keyword",
      info: "Continue until all user goals are met",
      apply: addColonAndIndent,
    },
    { label: "default", type: "keyword", info: "Default conversation style" },
    {
      label: "max_cost",
      type: "keyword",
      info: "Maximum cost in dollars of the conversation",
      apply: addColonAndSpace,
    },
  ],
  "conversation.goal_style.all_answered": [
    {
      label: "limit",
      type: "keyword",
      info: "Maximum number of steps before the conversation ends",
      apply: addColonAndSpace,
    },
  ],
  "conversation.interaction_style": [
    { label: "long phrase", type: "value", info: "Use longer phrases" },
    {
      ...
      type: "value",
      info: "Change opinions during conversation",
    },
    {
      label: "change language",
      type: "value",
      info: "Change language during conversation (provide list)",
      apply: addColonIndentAndList,
    },
    {
      label: "make spelling mistakes",
      type: "value",
      info: "Introduce spelling errors",
    },
    {
      label: "single question",
      type: "value",
      info: "Ask only one question at a time",
    },
    {
      label: "all questions",
      type: "value",
      info: "Ask all questions at once",
    },
    {
      label: "default",
      type: "value",
      info: "Default conversation style without modifications",
    },
    {
      label: "random",
      type: "keyword",
      info: "Select a random interaction style from a list",
      apply: addColonIndentAndList,
    },
  ],
...
export function levenshteinDistance(a, b) {
  ...
  for (let index = 0; index <= a.length; index++) matrix[index][0] = index;
  for (let index = 0; index <= b.length; index++) matrix[0][index] = index;
  ...
  return (view) => {
    ...
    for (const [lineIndex, line] of lines.entries()) {
      ...
      if (regularKeyMatch) {
        ...
        continue; // No key found in this line
      }
...
export function getCursorContext(document_, pos) {
  // Get all text up to cursor position
  const textUpToCursor = document_.sliceString(0, pos);
