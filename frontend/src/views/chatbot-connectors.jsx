...
const ChatbotConnectors = () => {
  ...
  return (
    <div className="flex flex-col items-center space-y-4 sm:space-y-6 lg:space-y-8 w-full max-w-5xl mx-auto my-auto max-h-[90vh] p-4 sm:p-6 lg:p-8">
      {/* Setup Status Dashboard */}
      <div className="w-full">
        <SetupStatusDashboard compact={true} showTitle={false} />
      </div>

      <div className="w-full max-w-3xl mx-auto space-y-4 sm:space-y-6 lg:space-y-8">
        ...
        <div className="flex justify-center">
          <Button
            color="primary"
            onPress={onOpen}
            className="w-full sm:max-w-[200px] h-10 sm:h-12"
            startContent={<Plus className="w-4 h-4 mr-1" />}
          >
            Create New Connector
          </Button>
