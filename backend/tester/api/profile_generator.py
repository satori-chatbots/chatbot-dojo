...
class ProfileGenerator:
    ...
    def process_tracer_results_dual_storage(
        self, execution: ProfileExecution, output_dir: Path
    ) -> None:
        ...
        # Move analysis files – README.md plus any workflow_graph.<ext> that exist
        ...
        TracerAnalysisResult.objects.create(
            execution=execution,
            report_file_path=str(readme_path.relative_to(Path(settings.MEDIA_ROOT))) if readme_path.exists() else "",
